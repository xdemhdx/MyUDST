    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.form}>
        <View style={styles.profileSection}>
          <Icon name="user-graduate" size={25} color="#4b4f56" />
          <Text style={styles.profileName}>{name}</Text>
        </View>

        <View style={styles.detailSection}>
          <View style={styles.detailRow}>
            <Icon name="id-card" size={18} color="#4b4f56" />
            <Text style={styles.detailText}>ID: {id}</Text>
          </View>

          <View style={styles.detailRow}>
            <Icon name="envelope" size={18} color="#4b4f56" />
            <Text style={styles.detailText}>Email: {email}</Text>
          </View>

          <View style={styles.detailRow}>
            <Icon name="book" size={18} color="#4b4f56" />
            <Text style={styles.detailText}>Major: {major}</Text>
          </View>

          <View style={styles.detailRow}>
            <Icon name="university" size={18} color="#4b4f56" />
            <Text style={styles.detailText}>College: {college}</Text>
          </View>

          <View style={styles.detailRow}>
            <Icon name="phone" size={18} color="#4b4f56" />
            <Text style={styles.detailText}>Mobile: {mobile}</Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
